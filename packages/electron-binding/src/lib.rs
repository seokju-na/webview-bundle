...
use webview_bundle_protocol::{FileSource, Protocol};
...
pub struct LocalProtocol {
  inner: Arc<webview_bundle_protocol::LocalProtocol>,
}
...
impl LocalProtocol {
  ...
  pub fn new(mapping: HashMap<String, String>) -> Self {
    Self {
      inner: Arc::new(webview_bundle_protocol::LocalProtocol::new(mapping)),
    }
  }
...
pub struct BundleProtocol {
  inner: Arc<webview_bundle_protocol::BundleProtocol<FileSource>>,
}
...
impl BundleProtocol {
  ...
  pub fn new(base_dir: String) -> Self {
    Self {
      inner: Arc::new(webview_bundle_protocol::BundleProtocol::new(
